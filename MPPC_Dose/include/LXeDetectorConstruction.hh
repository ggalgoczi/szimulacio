...
G4Box* CutOut_box;
    G4LogicalVolume* CutOut_log;
    G4VPhysicalVolume* CutOut_phys;

G4Box* MPPC_box;
    G4LogicalVolume* MPPC_log;
    G4VPhysicalVolume* MPPC_phys;

G4Box* CsI_box1;
    G4LogicalVolume* CsI_log1;
    G4VPhysicalVolume* CsI_phys1;

G4Box* CsI_box2;
    G4LogicalVolume* CsI_log2;
    G4VPhysicalVolume* CsI_phys2;
