...
// CAD MESH END	
  ...
  G4double expHall_x = fScint_x+fD_mtl+2*m;
  G4double expHall_y = fScint_y+fD_mtl+2*m;
  G4double expHall_z = fScint_z+fD_mtl+2*m;
...
//cad_physical_8 = new G4PVPlacement(0, G4ThreeVector(10*cm,-10*cm,0.), cad_logical_8,
