...
//
  ...
  G4LogicalVolume* waterTank_log
    = new G4LogicalVolume(waterTank_box,air,"Tank",0,0,0);
...
//
 ...
 G4Box* CsI_Box = new G4Box("CsI",CsI_x,CsI_y,CsI_z);

  G4LogicalVolume* CsI_log
    = new G4LogicalVolume(CsI_Box,water,"CsI",0,0,0);

  G4VPhysicalVolume* CsI_phys
    = new G4PVPlacement(0,G4ThreeVector(0.1*m,0,0),CsI_log,"CsI",
...
//
  ...
  G4LogicalSkinSurface* airSurface =
          new G4LogicalSkinSurface("AirSurface", waterTank_log, opAirSurface);

  G4OpticalSurface* opticalSurface = dynamic_cast <G4OpticalSurface*>
        (airSurface->GetSurface(waterTank_log)->GetSurfaceProperty());
...
//
  ...
  G4double ephoton[num] = {0.034*eV, 400.136*eV};
/*
  //OpticalWaterSurface
  ...
  G4double REFLECTIVITY_water[num]   = {0.8, 1.0};

  G4MaterialPropertiesTable* myST1 = new G4MaterialPropertiesTable();

  myST1->AddProperty("RINDEX",                ephoton, refractiveIndex, num);
  myST1->AddProperty("REFLECTIVITY",          ephoton, REFLECTIVITY_water, num);
